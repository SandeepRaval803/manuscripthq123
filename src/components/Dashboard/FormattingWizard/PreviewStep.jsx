...
export function PreviewStep({ metadata, manuscriptData, getPreviewStyles, selectedTheme, exportFormat }) {
  return (
    <div className="space-y-6">
      ...
      <BookPreview metadata={metadata} manuscriptData={manuscriptData} getPreviewStyles={getPreviewStyles} />

...
export function PreviewStep({ metadata, dedication, manuscriptData, getPreviewStyles, pageImages, textOverlays, ageGroup, trimSize, binding }) {
  return (
    <div className="space-y-6">
      ...
      <ChildBookPreview metadata={metadata} dedication={dedication} manuscriptData={manuscriptData} getPreviewStyles={getPreviewStyles} pageImages={pageImages} textOverlays={textOverlays} readOnly={true} ageGroup={ageGroup} trimSize={trimSize} binding={binding} />
